...
AdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.gameslist).setOnClickListener(v ->
                startActivity(new Intent(AdminActivity.this,GameListActivity.class))
        );
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds: snapshot.getChildren()){
                    ...
                    Data data = new Data(Objects.requireNonNull(FirebaseAuth.getInstance().getCurrentUser()).getUid(), name + ": " + message, "Announcement!", hisId, "profile", R.drawable.ic_push_notification);
                    assert token != null;
