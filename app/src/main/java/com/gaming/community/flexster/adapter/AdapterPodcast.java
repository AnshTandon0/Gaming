...
import com.gaming.community.flexster.podcast.PodcastActivity;
...
public class AdapterPodcast extends RecyclerView.Adapter<AdapterPodcast.MyHolder>{
    ...
    int channelProfile;
    public static final String channelMessage = "com.gaming.community.flexster.CHANNEL";
    public static final String profileMessage = "com.gaming.community.flexster.PROFILE";
