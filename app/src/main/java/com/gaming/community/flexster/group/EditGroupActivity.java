...
public class EditGroupActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //*****getclubPrivacy*****
        FirebaseDatabase.getInstance().getReference().child("Groups").child(id)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (club_private.equals("public")){
                            ...
                            radio_club_private.setChecked(true);
        ...
        radio_club_public.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EditGroupActivity.this, "Public", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        radio_club_private.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FirebaseDatabase.getInstance().getReference("Groups")
                        .child(id)
                        .updateChildren(hashMap);
                Toast.makeText(EditGroupActivity.this, "Private", Toast.LENGTH_SHORT).show();
            }
        });
