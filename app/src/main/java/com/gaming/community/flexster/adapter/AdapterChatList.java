...
import com.gaming.community.flexster.model.ModelChat;
...
public class AdapterChatList extends RecyclerView.Adapter<AdapterChatList.MyHolder>{
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.img_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FirebaseDatabase.getInstance().getReference("Chatlist")
                        .child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(modelChatLists.get(position).getId()).removeValue();

                FirebaseDatabase.getInstance().getReference("Chatlist")
                        .child(modelChatLists.get(position).getId()).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).removeValue();

            }
        });

        //UserInfo
        FirebaseDatabase.getInstance().getReference().child("Users").child(modelChatLists.get(position).getId())
        ...
        holder.itemView.setOnClickListener(v -> {
            ...
            FirebaseDatabase.getInstance().getReference("Users").child(modelChatLists.get(position).getId())
                    .child("BlockedUsers")
        ...
        //AdminInfo
        FirebaseDatabase.getInstance().getReference("Admin").child(modelChatLists.get(position).getId())
                .addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()) {
        ...
        //PostCount
        PostCount.getfightlevel(modelChatLists.get(position).getId(),holder.txt_fight_count);
        PostCount.getengagelevel(modelChatLists.get(position).getId(),holder.txt_post_count);
       ...
       /* FirebaseDatabase.getInstance().getReference("Chats").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds : snapshot.getChildren()){
                    ...
                    if (Objects.requireNonNull(ds.child("sender").getValue()).toString()
                            .equals(modelChatLists.get(position).getId()) && Objects.requireNonNull(ds.child("receiver").getValue())
                            .toString().equals(Objects.requireNonNull(FirebaseAuth.getInstance().getCurrentUser()).getUid())){
    ...
    static class MyHolder extends RecyclerView.ViewHolder{
        ...
        ImageView admin;
        TextView txt_fight_count,txt_post_count;
