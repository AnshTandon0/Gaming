...
public class AdapterComment extends RecyclerView.Adapter<AdapterComment.MyHolder>{
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        FirebaseDatabase.getInstance().getReference().child("Users")
                .child(modelComments.get(position).getId())
        ...
        //AdminInfo
        FirebaseDatabase.getInstance().getReference("Admin").child(modelComments.get(position).getId())
        ...
        //PostCount
        PostCount.getfightlevel(modelComments.get(position).getId(),holder.txt_fight_count);
        PostCount.getengagelevel(modelComments.get(position).getId(),holder.txt_post_count);
