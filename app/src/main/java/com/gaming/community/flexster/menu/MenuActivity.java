...
import com.gaming.community.flexster.admin.GlobalAdminRequestActivity;
...
import com.gaming.community.flexster.marketPlace.MarketPlaceActivity;
...
import com.gaming.community.flexster.reel.ReelActivity;
import com.gaming.community.flexster.search.LocationActivity;
import com.gaming.community.flexster.search.SearchActivity;
import com.gaming.community.flexster.send.ImageEditingActivity;
import com.gaming.community.flexster.send.VideoEditingActivity;
...
public class MenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.global_admin).setOnClickListener(v -> startActivity(new Intent(MenuActivity.this, GlobalAdminRequestActivity.class)));
        ...
        findViewById(R.id.invite).setOnClickListener(v -> {
            String shareBody = "Flexster - Gaming Community" + " Download now on play store \nhttps://play.google.com/store/apps/details?id=com.gaming.community.flexster";
