...
public class AdapterChat extends RecyclerView.Adapter<AdapterChat.MyHolder>{
    ...
    public void onBindViewHolder(@NonNull AdapterChat.MyHolder holder, final int position) {
        ...
        holder.text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ( modelChats.get(position).getType().equalsIgnoreCase("meet") ) {
                    ...
                    intent.putExtra("creatore_id",modelChats.get(position).getPost_id());
                    intent.putExtra("postID", modelChats.get(position).getWin_post_id());
                    context.startActivity(intent);
                }
                else if (modelChats.get(position).getWin_type().equals("group_fight_log")){
                    Intent intent = new Intent(context, GroupFightLogCommentActivity.class);
                    intent.putExtra("group_id",modelChats.get(position).getPost_id());
                    intent.putExtra("postID", modelChats.get(position).getWin_post_id());
                    context.startActivity(intent);
                }
                    ...
                    intent.putExtra("user_id",modelChats.get(position).getPost_id());
                    intent.putExtra("postID", modelChats.get(position).getWin_post_id());
                    context.startActivity(intent);
                }
                    ...
                    intent.putExtra("group",modelChats.get(position).getPost_id());
                    intent.putExtra("postID", modelChats.get(position).getWin_post_id());
                    context.startActivity(intent);
                }
            }
        ...
        if (modelChats.get(position).getType().equals("text")){
            ...
            if (modelChats.get(position).getMsg().equals("Saved a fight result")){
                holder.text.setTextColor(Color.parseColor("#D20000"));
                holder.img_win.setVisibility(View.VISIBLE);
            }
            else if (modelChats.get(position).getMsg().equals("Approved a fight result")){
                holder.text.setTextColor(Color.parseColor("#D20000"));
                holder.img_win.setVisibility(View.VISIBLE);
            }
            else if (modelChats.get(position).getMsg().equals("Rejected a fight result")){
                holder.text.setTextColor(Color.parseColor("#D20000"));
                holder.img_win.setVisibility(View.VISIBLE);
            }
            else if (modelChats.get(position).getMsg().equals("Shared a post")){
                holder.text.setTextColor(Color.parseColor("#D20000"));
                holder.img_win.setVisibility(View.VISIBLE);
            }
            else if (modelChats.get(position).getMsg().equals("Shared a fight result")){
                holder.text.setTextColor(Color.parseColor("#D20000"));
                holder.img_win.setVisibility(View.VISIBLE);
            }
        ...
        else if (modelChats.get(position).getType().equals("meet")) {
            holder.text.setVisibility(View.VISIBLE);
            holder.text.setLinkText(modelChats.get(position).getMsg());
            holder.img_win.setVisibility(View.VISIBLE);
        }
