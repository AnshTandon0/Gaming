...
import com.gaming.community.flexster.post.LookinForActivity;
...
import com.gaming.community.flexster.post.FeelingActivity;
import com.gaming.community.flexster.post.PrivacyPick;
...
public class CreateGroupPostActivity extends AppCompatActivity implements PrivacyPick.SingleChoiceListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.create_group_post);
        ...
        findViewById(R.id.gameforimg).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Dialog dialog = new Dialog(CreateGroupPostActivity.this,R.style.CustomDialog);
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        adapterDialogGameList = new AdapterDialogGameList(CreateGroupPostActivity.this,modelGameLists,gamenameItemListener);
                        mlayoutManager = new LinearLayoutManager(CreateGroupPostActivity.this, LinearLayoutManager.VERTICAL, false);
                    ...
                    public void onCancelled(DatabaseError databaseError) {
                        Toast.makeText(CreateGroupPostActivity.this, "Couldn't Load Data", Toast.LENGTH_SHORT).show();
                    }
                });
              ...
              if (Objects.requireNonNull(bg_text.getText()).toString().isEmpty()){
                  ...
                  if (number.equals("upload")){
                     ...
                     FirebaseDatabase.getInstance().getReference().child("Groups").child(groupID).child("Posts").child(timeStamp).setValue(hashMap);
                      ...
                      PostCount.increaseGroupPost(groupID,timeStamp,FirebaseAuth.getInstance().getCurrentUser().getUid());
