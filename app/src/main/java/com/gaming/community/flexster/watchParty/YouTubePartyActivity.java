...
import com.gaming.community.flexster.adapter.AdapterPartyChat;
import com.gaming.community.flexster.model.ModelPartyChat;
...
public class YouTubePartyActivity extends YouTubeBaseActivity {
    ...
    public static final String YOUR_API_KEY = "AIzaSyAdEyGGvB_M_9gyhkDCpldfCODuPzKuyJU";
    String id;
