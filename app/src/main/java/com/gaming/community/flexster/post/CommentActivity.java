...
public class CommentActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    //String
    String postID,hisId,creatore_id;
    //,check_intent,creatore_id
    ...
    //Post
    CircleImageView dp;
    ImageView verified,activity,mediaView,like_img,more,admin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ll_feeling = findViewById(R.id.ll_feeling);
        ...
        check_intent = getIntent().getStringExtra("check_intent");
        creatore_id = getIntent().getStringExtra("creater_id");*/
        creatore_id = getIntent().getStringExtra("creatore_id");
        ...
        if (getIntent().hasExtra("gif"))
        {
            ...
            Snackbar.make(main, "Sticker posted", Snackbar.LENGTH_LONG).show();
        }
        else {
            postID = getIntent().getStringExtra("postID");
            creatore_id = getIntent().getStringExtra("creatore_id");
        ...
        Log.e("founderror","errir1");
        //Comment
        loadComments();
        Log.e("founderror","errir2");
        ...
        FirebaseDatabase.getInstance().getReference().child("Post").child(postID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                FirebaseDatabase.getInstance().getReference().child("Users")
                        .child(snapshot.child("id").getValue().toString())
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        //AdminInfo
                        FirebaseDatabase.getInstance().getReference("Admin").child(hisId)
                        ...
                        //PostCount
                        PostCount.getfightlevel(hisId,txt_fight_count);
                        PostCount.getengagelevel(hisId,txt_post_count);
                        ...
                        if (snapshot.exists()){
                            ...
                            if(snapshot.child("game").exists())
                            {
                                if (snapshot.child("game").getValue().toString().equals("")){
                                    ...
                                    username.setText(snapshot.child("game").getValue().toString());
                            ...
                            if (!snapshot.child("feeling").getValue().toString().isEmpty()){
                                ll_feeling.setVisibility(View.VISIBLE);
                                feeling.setText(snapshot.child("feeling").getValue().toString());
                            }
                            else {
                                ll_feeling.setVisibility(View.GONE);
                            }
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Likes").addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                if (dataSnapshot.child(postID).hasChild(FirebaseAuth.getInstance().getCurrentUser().getUid())) {
                                    ...
                                    addToHisNotification(hisId, "Reacted on post");
                                    notify = true;
                ...
                sharePop.setOnMenuItemClickListener(item -> {
                    ...
                    if (item.getItemId() == 0){
                        ...
                        intent.putExtra("post_id",creatore_id);
                        intent.putExtra("win_post_id",postID);
                    ...
                    if (item.getItemId() == 1){
                        ...
                        intent.putExtra("type", "post");
                        intent.putExtra("uri", postID);
                        intent.putExtra("creater_win_id",creatore_id);
                        intent.putExtra("win_post_id",postID);
                        intent.putExtra("win_type","post");
                        startActivity(intent);
                    }
        ...
        /*if (check_intent.equals("Post")) {


        }
        else if(check_intent.equals("Fight"))
        {
        ...
        findViewById(R.id.comment_send).setOnClickListener(v ->
        {
            ...
            if (mComment.isEmpty())
            {
                ...
                findViewById(R.id.progressBar).setVisibility(View.GONE);
                Snackbar.make(main, "Opinion posted", Snackbar.LENGTH_LONG).show();
                editText.setText("");
                addToHisNotification(hisId, "Posted an opinion");
                notify = true;
                FirebaseDatabase.getInstance().getReference("Users").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                /*if (check_intent.equals("Post")){
                    ...
                    FirebaseDatabase.getInstance().getReference("FightLog").child(creatore_id).child(postID)
                            .child("Comments").child(timeStamp).setValue(hashMap);
    ...
    private void uploadVideo(Uri videoUri) {
        ...
        storageReference.putFile(videoUri).addOnSuccessListener(taskSnapshot -> {
            ...
            if (uriTask.isSuccessful()){
                ...
                findViewById(R.id.progressBar).setVisibility(View.GONE);
                Snackbar.make(main, "Photo posted", Snackbar.LENGTH_LONG).show();
                addToHisNotification(hisId, "Posted an opinion");
                notify = true;
                FirebaseDatabase.getInstance().getReference("Users").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
