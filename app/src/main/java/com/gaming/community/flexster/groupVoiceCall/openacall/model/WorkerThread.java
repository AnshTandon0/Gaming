package com.gaming.community.flexster.groupVoiceCall.openacall.model;
    ...
    private RtcEngine ensureRtcEngineReadyLock() {
        if (mRtcEngine == null) {
            ...
            try {
                ...
                mRtcEngine = RtcEngine.create(mContext, "c5f6d36dbfdf405e963d78e9bae2626a", mEngineEventHandler.mRtcEventHandler);
            } catch (Exception e) {
