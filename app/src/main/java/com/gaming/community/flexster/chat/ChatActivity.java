...
import com.gaming.community.flexster.adapter.AdapterChat;
...
import com.gaming.community.flexster.calling.CallingActivity;
...
public class ChatActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //fight log
        fight_log = findViewById(R.id.fight_log);

        fight_log.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(ChatActivity.this,PostFightLogActivity.class);
                i.putExtra("oponentidis",hisId);
                startActivity(i);
            }
        });
        getblockedstatuss();
        ...
        findViewById(R.id.message_send).setOnClickListener(v -> {
            ...
            if (editText.getText().toString().isEmpty()){
                ...
                if(isblocked)
                {
                    Toast.makeText(ChatActivity.this, "You are not allowed!", Toast.LENGTH_SHORT).show();
    ...
    private void getblockedstatuss() {

        FirebaseDatabase.getInstance().getReference("Users").child(hisId)
                .child("BlockedUsers")
