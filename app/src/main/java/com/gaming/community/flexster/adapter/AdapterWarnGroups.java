                ...
                if (id == 4) {
                    new AlertDialog.Builder(context)
                            ...
                            .setPositiveButton("Yes", (dialog, whichButton) -> {
                                ...
                                FirebaseDatabase.getInstance().getReference().child("Groups").child(userList.get(position).getGroupId()).child("status").setValue("0")
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(context, "Failed Group deactivated", Toast.LENGTH_SHORT).show();
                                    }
                                });
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds: snapshot.getChildren()){
                    ...
                    Data data = new Data(Objects.requireNonNull(FirebaseAuth.getInstance().getCurrentUser()).getUid(), name + " " + message, "Attention!", hisId, "group", R.drawable.ic_push_notification);
                    assert token != null;
